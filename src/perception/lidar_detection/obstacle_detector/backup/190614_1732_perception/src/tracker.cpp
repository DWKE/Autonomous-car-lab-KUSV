...
void Tracker::initTransformation()
{
	Eigen::Translation3f tl_btol(m_tf_x, m_tf_y, m_tf_z); // tl: translation Eigen::AngleAxisf rot_x_btol(_tf_roll, Eigen::Vector3f::UnitX()); // rot: rotation
	Eigen::AngleAxisf rot_x_btol(m_tf_roll, Eigen::Vector3f::UnitX()); // rot: rotation
	Eigen::AngleAxisf rot_y_btol(m_tf_pitch, Eigen::Vector3f::UnitY());
	Eigen::AngleAxisf rot_z_btol(m_tf_yaw, Eigen::Vector3f::UnitZ());
	m_tf_Base2Local = (tl_btol * rot_z_btol * rot_y_btol * rot_x_btol).matrix();
	m_tf_Local2Base = m_tf_Base2Local.inverse();
}
