// Generated by gencpp from file can/kusv_CanInfo.msg
// DO NOT EDIT!


#ifndef CAN_MESSAGE_KUSV_CANINFO_H
#define CAN_MESSAGE_KUSV_CANINFO_H
...
struct kusv_CanInfo_
{
  ...
  typedef boost::shared_ptr< ::can::kusv_CanInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::can::kusv_CanInfo_<ContainerAllocator> const> ConstPtr;

}; // struct kusv_CanInfo_

typedef ::can::kusv_CanInfo_<std::allocator<void> > kusv_CanInfo;

typedef boost::shared_ptr< ::can::kusv_CanInfo > kusv_CanInfoPtr;
typedef boost::shared_ptr< ::can::kusv_CanInfo const> kusv_CanInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::can::kusv_CanInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::can::kusv_CanInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'can_msgs': ['/opt/ros/kinetic/share/can_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'can': ['/home/lke/ACL_KUSV/src/sensing/can/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::can::kusv_CanInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::can::kusv_CanInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::can::kusv_CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::can::kusv_CanInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::can::kusv_CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::can::kusv_CanInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::can::kusv_CanInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::can::kusv_CanInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0d05be062e80361fULL;
  static const uint64_t static_value2 = 0xb3d556c45a03d561ULL;
};

template<class ContainerAllocator>
struct DataType< ::can::kusv_CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::can::kusv_CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::can::kusv_CanInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::can::kusv_CanInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::can::kusv_CanInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CAN_MESSAGE_KUSV_CANINFO_H
