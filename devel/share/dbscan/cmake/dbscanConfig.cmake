...
if("TRUE" STREQUAL "TRUE")
  set(dbscan_SOURCE_PREFIX /home/lke/ACL_KUSV/src/perception/lidar_detection/dbscan)
  set(dbscan_DEVEL_PREFIX /home/lke/ACL_KUSV/devel)
  set(dbscan_INSTALL_PREFIX "")
  set(dbscan_PREFIX ${dbscan_DEVEL_PREFIX})
else()
  set(dbscan_SOURCE_PREFIX "")
  set(dbscan_DEVEL_PREFIX "")
  set(dbscan_INSTALL_PREFIX /home/lke/ACL_KUSV/install)
...
if(NOT "/home/lke/ACL_KUSV/src/perception/lidar_detection/dbscan/include " STREQUAL " ")
  set(dbscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/lke/ACL_KUSV/src/perception/lidar_detection/dbscan/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'kys768 <kys768@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lke/ACL_KUSV/src/perception/lidar_detection/dbscan/${idir}'.  ${_report}")
    endif()
    _list_append_unique(dbscan_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "dbscan")
...
set(depends "pcl_conversions;pcl_ros;roscpp;sensor_msgs;std_msgs")
foreach(depend ${depends})
  ...
  list(APPEND dbscan_EXPORTED_TARGETS ${${dbscan_dep}_EXPORTED_TARGETS})
endforeach()
