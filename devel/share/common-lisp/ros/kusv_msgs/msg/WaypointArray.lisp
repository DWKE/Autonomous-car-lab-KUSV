...
(cl:defclass <WaypointArray> (roslisp-msg-protocol:ros-message)
  ((waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector kusv_msgs-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'kusv_msgs-msg:Waypoint :initial-element (cl:make-instance 'kusv_msgs-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kusv_msgs-msg:<WaypointArray> is deprecated: use kusv_msgs-msg:WaypointArray instead.")))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <WaypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kusv_msgs-msg:waypoints-val is deprecated.  Use kusv_msgs-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'kusv_msgs-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WaypointArray>)))
  ...
  "bd8cd3bad318acea3b5f67f7eb14b5d3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WaypointArray)))
  "Returns md5sum for a message object of type 'WaypointArray"
  "bd8cd3bad318acea3b5f67f7eb14b5d3")
