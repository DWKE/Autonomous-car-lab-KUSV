...
"""autogenerated by genpy from kusv_msgs/WaypointArray.msg. Do not edit."""
import sys
...
class WaypointArray(genpy.Message):
  _md5sum = "bd8cd3bad318acea3b5f67f7eb14b5d3"
  _type = "kusv_msgs/WaypointArray"
...
"""
  __slots__ = ['waypoints']
  _slot_types = ['kusv_msgs/Waypoint[]']
